\documentclass[$if(subject-titled)$subject=titled,$endif$$if(fontsize)$$fontsize$,$endif$$if(lang)$$lang$,$endif$$if(papersize)$$papersize$,$endif$$for(classoption)$$classoption$$sep$,$endfor$]{scrlttr2}
$if(fontfamily)$
...
$if(foldmarks)$
\KOMAoptions{foldmarks=$foldmarks$}
$endif$
$if(no-head)$
\KOMAoptions{firsthead=false}
$endif$
$if(fromalign)$
\KOMAoptions{fromalign=$fromalign$}
$else$
\KOMAoptions{fromalign=right}
$endif$
$if(fromrule)$
\KOMAoptions{fromrule=$fromrule$}
$endif$
